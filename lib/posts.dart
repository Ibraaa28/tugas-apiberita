  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        selectedItemColor: const Color.fromARGB(255, 6, 62, 214), // Warna oranye untuk elemen terpilih
      ...
      appBar: AppBar(
        title: Text(
          ...
          style: TextStyle(
            ...
            letterSpacing: 2.0,
            color: const Color.fromARGB(255, 5, 123, 202), // Warna oranye untuk logo
          ),
        ),
